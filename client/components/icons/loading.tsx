...
const Loading = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      id="Loading-Fill--Streamline-Mingcute-Fill"
      height="16"
      width="16"
    >
      <desc>Loading Fill Streamline Icon: https://streamlinehq.com</desc>
      <defs>
        <linearGradient id="a" x1="50%" x2="50%" y1="5.271%" y2="91.793%">
          <stop offset="0%" stop-color="#000000"></stop>
          <stop offset="100%" stop-color="#000000" stop-opacity=".55"></stop>
        </linearGradient>
